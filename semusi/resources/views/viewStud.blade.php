...
@section('content')
        ...
        <form method="POST" action="">
                        ...
                        <div class="form-group row">
                            <label for="employeeName" class="col-md-5 col-form-label text-md-right">{{ __('Student Name') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="designation" class="col-md-5 col-form-label text-md-right">{{ __('Roll No.') }}</label>

                            <div class="col-md-4">
                                 <label for="employeeName" class="col-md-5 col-form-label text-md-right">{{$form->rollno}}</label>
                            </div>
                        </div>
